...
<div class="card fluid">
    ...
    <ol>
        ...
        <li class="">Développer une page de liste d'articles</li>
            <ol>
                ...
                <li class="">dans ce fichier, écrire un modèle html qui présente les données suivantes : </li>
                    <ul>
        ...
        <li class="">Développer une page de détails d'un article (visualisation d'un article)</li>
            <ol>
        ...
        <li class="">Développer un formulaire d'ajout d'article</li>
            <ol>
